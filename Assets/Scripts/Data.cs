...
public static class Data
{
    ...
    public static readonly Dictionary<Tetromino, Vector2Int[]> Cells = new Dictionary<Tetromino, Vector2Int[]>()
    {
        ...
        //Pentomino figures
        { Tetromino.Ip, new Vector2Int[] { new Vector2Int(-2, 0), new Vector2Int( -1, 0), new Vector2Int( 0, 0), new Vector2Int( 1, 0), new Vector2Int( 2, 0) } },
        { Tetromino.Lp, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int(0, 1), new Vector2Int(0, -1), new Vector2Int( 0, -2), new Vector2Int( 1, -2) } },
        { Tetromino.Jp, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int(0, 1), new Vector2Int(0, -1), new Vector2Int( 0, -2), new Vector2Int( -1, -2) } },
        { Tetromino.Tp, new Vector2Int[] { new Vector2Int(-1, 1), new Vector2Int( 0, 1), new Vector2Int( 1, 1), new Vector2Int( 0, 0), new Vector2Int( 0, -1) } },
        ...
        { Tetromino.P, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( 1, 0), new Vector2Int( 0, 1), new Vector2Int( 1, 1), new Vector2Int(0, -1) } },
        { Tetromino.RevP, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( -1, 0), new Vector2Int( 0, 1), new Vector2Int( -1, 1), new Vector2Int(0, -1) } },
        { Tetromino.Worm1, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( 0, -1), new Vector2Int( -1, -1), new Vector2Int( -1, -2), new Vector2Int( 0, 1) } },
        { Tetromino.Worm2, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( 0, -1), new Vector2Int( 1, -1), new Vector2Int( 1, -2), new Vector2Int( 0, 1) } },
        ...
        { Tetromino.Angle, new Vector2Int[] { new Vector2Int(1, 0), new Vector2Int( 1, 1), new Vector2Int( 1, -1), new Vector2Int( 0, -1), new Vector2Int( -1, -1) } },
        { Tetromino.Stairs, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int( -1, -1), new Vector2Int( 0, -1), new Vector2Int( 1, 0), new Vector2Int( 1, 1) } },
        ...
        { Tetromino.Zombie1, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( 0, 1), new Vector2Int( 1, 0), new Vector2Int( 0, -1), new Vector2Int( 0, -2) } },
        { Tetromino.Zombie2, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( 0, 1), new Vector2Int( -1, 0), new Vector2Int( 0, -1), new Vector2Int( 0, -2) } },
    };
    //wallkicks for figure I
    ...
    //wallkicks for every other figure
    ...
    //assigning wallkicks to figures
